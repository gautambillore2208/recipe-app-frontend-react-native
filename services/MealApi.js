...
//         console.error("Error geting meals by id:",error);
//         return null
...
//     } catch (error) {
//         console.error("Error geting  by random meals:",error);
//         return null
//     }
...
//         const meals = await promises.all(promises)
//         return meals.filter((meal)=>meal !== null);
//     } catch (error) {
//           console.error("Error geting  by random meals2:",error);
//         return null
...
//     } catch (error) {
//            console.error("Error geting  by categories:",error);
//         return null
//     }
// }
